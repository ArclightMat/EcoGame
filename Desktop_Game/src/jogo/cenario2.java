...
public class cenario2 extends colisao {
	...
	public cenario2 (Window window) {
		 ...
		 jogador.contador = cenario.jogador.contador;
		 lixo = new Lixo[4];
		 lixo[0] = new Lixo(185, 500, "lixo.png");
		 lixo[1] = new Lixo(315, 530, "lixo.png");
		 lixo[2] = new Lixo(445, 500, "lixo.png");
		 lixo[3] = new Lixo(615, 520, "lixo.png");
